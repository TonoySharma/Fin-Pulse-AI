    ...
    <FadeUp>
      <div className="h-[830px] bg-slate-950 text-slate-100 flex items-center justify-center p-4 lg:p-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-6xl bg-slate-900/80 border border-slate-800/80 rounded-3xl shadow-2xl backdrop-blur-xl overflow-hidden grid lg:grid-cols-12">
          ...
          {/* Left Side: Tech Banner & Value Props */}
          <div className="hidden lg:flex lg:col-span-5 flex-col justify-between bg-gradient-to-br from-indigo-950/90 via-slate-900 to-slate-950 p-10 border-r border-slate-800/80 relative">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-white leading-tight">
                Unlock the Future of <span className="text-indigo-400">Agentic AI</span>
              </h1>

              <p className="text-sm text-slate-400 leading-relaxed">
                Join our ecosystem to access autonomous agents, intelligent gadgets, and automated workflow solutions tailored for high efficiency.
              </p>
            ...
            <div className="mt-10 p-4 rounded-2xl bg-slate-950/60 border border-slate-800 text-xs text-slate-400 flex items-center justify-between">
              ...
              <span className="text-indigo-400 font-medium">Learn More &rarr;</span>
            </div>
          </div>
            ...
            <div className="max-w-md mx-auto w-full space-y-6">
              ...
              <div className="text-center lg:text-left space-y-2">
                ...
                <p className="text-sm text-slate-400">
                  Enter your credentials below to create your workspace
                </p>
              </div>
              ...
              <Button
                ...
                className="w-full flex items-center justify-center gap-3 bg-slate-800/80 hover:bg-slate-800 text-slate-200 border border-slate-700/80 py-6 rounded font-medium transition-all"
              >
                <FcGoogle size={22} />
              ...
              <Form className="flex flex-col gap-4" onSubmit={onSubmit}>
                ...
                <TextField
                  ...
                  className="w-full"
                  validate={(value) =>
                    value.length < 8 ? "Confirm password must be at least 8 characters" : null
                  }
                >
                  <Label className="text-xs font-medium text-slate-300">
                    Confirm Password
                  </Label>
                  <InputGroup className="bg-slate-950/60 border border-slate-800 rounded overflow-hidden
